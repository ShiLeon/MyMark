...
+ $3\sigma$ 原则
  ![a](https://gitee.com/ShiLeon/my-mark-image-repository/raw/master/a.jpg)
...
其中$r_{xx}=\frac{\partial^2{G}}{\partial{x}^2}*f(x,y)$

        $r_{yy}=\frac{\partial^2{G}}{\partial{y}^2}*f(x,y)$

        $r_{xy}=\frac{\partial^2{G}}{\partial{x}\partial{y}}*f(x,y)$
